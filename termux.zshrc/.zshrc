...
# see $PREFIX/share/doc/zsh/examples/zshrc for examples
...
if [ "$color_prompt" = yes ]; then
    ...
    if [ -f $ZSH_SYNTAX_HIGHLIGHTING_ZSH ]; then
        . $ZSH_SYNTAX_HIGHLIGHTING_ZSH
...
if [ -f $ZSH_AUTOSUGGESTIONS_ZSH ]; then
    . $ZSH_AUTOSUGGESTIONS_ZSH
